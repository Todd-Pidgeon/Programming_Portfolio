...
public class ItemSpawner : MonoBehaviour {
	...
	void Start () {
        ...
        //Debug.Log(Test);
        Instantiate((Resources.Load("rareDrop")), GameObject.Find("Dirt (" + Random.Range(1, GameObject.FindGameObjectsWithTag("Pickup").Length) + ")").transform.position + new Vector3(0, 0.1f, 0), Quaternion.identity);
    }
